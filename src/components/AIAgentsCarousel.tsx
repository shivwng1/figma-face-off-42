...
const AIAgentsCarousel = () => {
  ...
  return (
    <section className="relative z-10 flex mt-[-259px] w-full max-w-[1240px] flex-col items-stretch max-md:max-w-full max-md:mt-[-200px]">
      ...
      <div className="mt-[50px] max-md:mt-10">
        <Carousel className="w-full max-w-[1200px] mx-auto">
          <CarouselContent className="-ml-2 md:-ml-4">
            {agents.map((agent, index) => (
              <CarouselItem key={index} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                <div className="bg-[rgba(255,255,255,0.02)] border rounded-[20px] border-[rgba(255,255,255,0.1)] border-solid overflow-hidden h-full">
                  ...
                  <div className="p-6">
                    <h3 className="text-[rgba(240,240,240,1)] text-xl font-medium leading-tight mb-3">
                      {agent.title}
                    </h3>
                    <p className="text-[rgba(206,206,207,1)] text-sm font-light leading-6 mb-4">
                      {agent.description}
                    </p>
                    <ul className="text-[rgba(206,206,207,1)] text-sm font-light leading-6 mb-6 space-y-1">
                    ...
                    <button className="bg-[rgba(255,255,255,0.02)] border flex min-h-[45px] items-center gap-3 text-sm text-white leading-loose w-full justify-center px-4 py-2 rounded-[25px] border-[rgba(255,255,255,0.1)] border-solid hover:opacity-80 transition-opacity">
